...
import { Post as PostEntity } from '../../typings';
  ...
  return (
    <main>
      ...
      {submitted ? (
        ...
        <form
          className="flex flex-col max-w-2xl p-10 mx-auto my-10 mb-10"
          onSubmit={handleSubmit(onSubmit)}
        >
          <h3 className="text-sm yext-yellow-500">Enjoyed this article?</h3>
          ...
          <label className="block mb-5">
            ...
            <textarea
              ...
              placeholder="Here you can type your comment"
              rows={8}
            />
          </label>
...
export const getStaticPaths = async () => {
  ...
  const paths = posts.map((post: PostEntity) => ({
